...
(function($) {
  ...
  var helpers = {
    createLine: function(x1, y1, x2, y2, options,identificador){
  ...
  $.fn.line = function( x1, y1, x2, y2, options, identificador, callbacks) {
                return $(this).each(function(){
                  ...
                  $(this).append(helpers.createLine(x1,y1,x2,y2,options,identificador)).promise().done(function(){
